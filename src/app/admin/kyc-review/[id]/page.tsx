                ...
                {status === "Pending" ? (
                    <>
                        ...
                        <button
                            ...
                            disabled={isVerifyingKyc}
                            className="flex-1 py-4 bg-[#0B2545] text-white rounded-xl font-bold text-[16px] hover:bg-[#071A33] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                        >
